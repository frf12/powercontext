...
```text
powercontext setup <host> --source frf12/powercontext --ref codex/guided-config
powercontext setup select --host codex --host dsh --source frf12/powercontext --ref codex/guided-config
