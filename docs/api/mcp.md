...
See [Configuration API](../guides/configuration.md) for configuration details.
...
- [MCP Server Source Code](https://github.com/oceanbase/powermem/tree/main/src/powermem/mcp) - MCP server implementation
