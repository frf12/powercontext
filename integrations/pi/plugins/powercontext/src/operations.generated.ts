...
export const OPERATIONS = {
  ...
  flush_topic_memory: { method: 'POST', path: '/v1/topic-memory/flush', location: "body", scope: true },
  search_topic_memory: { method: 'POST', path: '/v1/topic-memory/search', location: "body", scope: true },
  get_topic_memory: { method: 'POST', path: '/v1/topic-memory/get', location: "body", scope: true },
