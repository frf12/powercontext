    ...
    "paths": {
        ...
        "/v1/scopes/{scope_id}/trace-learning": {
            "post": {
                ...
                "description": "Accept complete "
                "user-selected traces "
                "for asynchronous "
                "learning. The same "
                "principal and "
                "idempotency key "
                "replay the original "
                "run. Queued or "
                "running work returns "
                "202; completed work "
                "returns 200.",
                "requestBody": {
                    "required": True,
                    "content": {
                        "application/json": {"schema": {"$ref": "#/components/schemas/ImportTraceLearningRequest"}}
                    },
                },
            }
        },
        "/v1/scopes/{scope_id}/trace-learning/{run_id}": {
            "get": {
                "tags": ["trace-learning"],
                "summary": "Read one trace learning run",
                "operationId": "get_learning_run",
                "x-powercontext-access": {"resolver": "path_scope_read_access"},
                "parameters": [
                    {
                        "name": "scope_id",
        ...
        "schemas": {
            ...
            "PreparedContext": {
                "properties": {
                    ...
                    "learned_context": {
                        "allOf": [{"$ref": "#/components/schemas/LearnedContext"}],
                ...
                "description": "Prepared text and optional "
                "structured learned context. A "
                "ready response may contain only "
            ...
            "ArtifactReadFamily": {
                "type": "string",
                "enum": ["memory", "experience", "skill", "handoff", "profile", "prompt", "topic-memory", "tool"],
            },
            ...
            "CompleteTrace": {
                "properties": {
                    "trace_id": {"type": "string", "maxLength": 256, "minLength": 1},
                    "question": {"type": "string", "maxLength": 64000, "minLength": 1},
                    "tool_calls": {
                    ...
                    "final_answer": {},
                    "context": {"additionalProperties": {}, "type": "object"},
                },
                "additionalProperties": False,
                "type": "object",
                "required": ["trace_id", "question", "tool_calls", "final_answer"],
            },
            "TraceLearningHostProfile": {
                "properties": {
                    "kind": {"type": "string", "enum": ["datus"], "default": "datus"},
                    "dialect": {"type": "string", "maxLength": 32, "minLength": 1},
                    "database_name": {"type": "string", "maxLength": 256, "minLength": 1, "nullable": True},
                },
                "additionalProperties": False,
                "type": "object",
                "required": ["dialect"],
            ...
            "TraceToolCall": {
                "properties": {
                    "call_id": {"type": "string", "maxLength": 256, "minLength": 1},
                    "name": {"type": "string", "maxLength": 256, "minLength": 1},
                ...
                "additionalProperties": False,
                "type": "object",
                "required": ["call_id", "name", "arguments", "result"],
            },
            "ImportTraceLearningRequest": {
                "properties": {
                    "idempotency_key": {"type": "string", "maxLength": 128, "minLength": 1},
                    "traces": {
                        "items": {"$ref": "#/components/schemas/CompleteTrace"},
                        "type": "array",
                        "maxItems": 32,
                        "minItems": 1,
                    },
            ...
            "ValidationReport": {
                "properties": {
                    "covered_path_verified": {"type": "boolean", "default": False},
                    "live_execution_verified": {"type": "boolean", "default": False},
                    "checked_examples": {"type": "integer", "default": 0},
                    "method": {
                        "type": "string",
                        "enum": ["recorded_sql_ast_equivalence"],
                        "default": "recorded_sql_ast_equivalence",
                    },
                    "detail": {
                        "type": "string",
                        "default": "Checks "
            ...
            "LearningRun": {
                "properties": {
                    ...
                    "sources": {
                        "items": {"$ref": "#/components/schemas/TraceLearningSourceReference"},
                        "type": "array",
                        "default": [],
                    },
                    "artifacts": {
                ...
                "type": "object",
                "required": ["scope_id", "run_id", "host_profile", "input_digest", "accepted_at"],
            },
            "LearnedExperience": {
                "properties": {"ref": {"$ref": "#/components/schemas/ArtifactReference"}, "text": {"type": "string"}},
                "additionalProperties": False,
                "type": "object",
                "required": ["ref", "text"],
            },
            "LearnedSkill": {
                "properties": {
                    "ref": {"$ref": "#/components/schemas/ArtifactReference"},
                ...
                "additionalProperties": False,
                "type": "object",
                "required": ["ref", "instructions"],
            },
            "LearnedTool": {
                "properties": {
                    "name": {"type": "string", "maxLength": 64, "minLength": 1, "pattern": "^[a-zA-Z][a-zA-Z0-9_-]*$"},
                    "description": {"type": "string", "maxLength": 2000, "minLength": 1},
                    "input_schema": {"additionalProperties": {}, "type": "object"},
                    "output_schema": {"additionalProperties": {}, "type": "object"},
                    "implementation": {"$ref": "#/components/schemas/SqlToolImplementation"},
                    "ref": {"$ref": "#/components/schemas/ArtifactReference"},
                },
                "additionalProperties": False,
                "type": "object",
                "required": ["name", "description", "input_schema", "output_schema", "implementation", "ref"],
            },
            "SqlToolImplementation": {
                "properties": {
                    "kind": {"type": "string", "enum": ["parameterized_sql"], "default": "parameterized_sql"},
                    "sql": {"type": "string", "maxLength": 131072, "minLength": 1},
                    "parameter_order": {"items": {"type": "string"}, "type": "array", "maxItems": 128},
                    "dialect": {"type": "string", "maxLength": 64, "minLength": 1, "default": "sqlite"},
                    "database_name": {"type": "string", "maxLength": 256, "minLength": 1, "nullable": True},
                },
                "additionalProperties": False,
                "type": "object",
            ...
            "LearnedContext": {
                "properties": {
                    "experiences": {
                        "items": {"$ref": "#/components/schemas/LearnedExperience"},
                        "type": "array",
                        "default": [],
                    },
                    "skills": {"items": {"$ref": "#/components/schemas/LearnedSkill"}, "type": "array", "default": []},
                    "tools": {"items": {"$ref": "#/components/schemas/LearnedTool"}, "type": "array", "default": []},
                },
                "additionalProperties": False,
                "type": "object",
            },
            "TraceLearningSourceReference": {
                "properties": {"source_type": {"type": "string"}, "source_id": {"type": "string"}},
                "type": "object",
                "required": ["source_type", "source_id"],
                "description": "A stable reference to one Source in the current catalog view.",
            },
        },
        "responses": {
            "BadRequest": {
